...
@Component({
	selector: 'app-card-news-carousel',
	standalone: true,
	imports: [CardSmComponent, NgFor, NgIf],
	templateUrl: './card-news-carousel.component.html',
	styleUrls: ['./card-news-carousel.component.css'],
})
export class CardNewsCarouselComponent implements OnInit {
	cards: Card[] = [];
	currentIndex: number = 0;
	itemsPerPage: number = 6;
	transform: string = 'translateX(0)';

	constructor(private cardService: CardNewsService) {}
